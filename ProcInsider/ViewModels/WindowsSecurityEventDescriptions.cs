...
/// <summary>Static English Security-source labels; generated from Windows provider definitions.
/// See docs/ai/WINDOWS_SECURITY_EVENT_DESCRIPTIONS.md for coverage and regeneration.</summary>
public static class WindowsSecurityEventDescriptions
{
    private static readonly FrozenDictionary<int, string> Labels = new Dictionary<int, string>
    {
        ...
        [1103] = "Security log approaching capacity",
        [1104] = "Security log full",
        [1105] = "Event log backed up automatically",
        [1106] = "Events dropped by logging service",
        [1107] = "Event publisher metadata processing failed",
        [1108] = "Incoming event processing failed",
        ...
        [4634] = "Account logoff",
        [4646] = "IKE denial-of-service prevention mode started",
        ...
        [4663] = "Object access right used",
        [4664] = "An attempt was made to create a hard link",
        [4665] = "An attempt was made to create an application client context",
        [4666] = "Application operation attempted",
        ...
        [4766] = "Adding SID history to account failed",
        ...
        [4776] = "Account credential validation attempted",
        [4777] = "The domain controller failed to validate the credentials for an account",
        [4778] = "A session was reconnected to a Window Station",
        [4779] = "A session was disconnected from a Window Station",
        [4780] = "Administrative account ACL set",
        ...
        [4794] = "Directory Services Restore Mode password set attempted",
        ...
        [4897] = "Certificate Services role separation setting",
        ...
        [4957] = "Windows Firewall rule not applied: reference resolved to an empty set",
        [4958] = "Windows Firewall rule not applied: referenced items are not configured",
        ...
        [5050] = "Unsupported request to disable Windows Firewall rejected",
        ...
        [5462] = "IPsec Policy Agent failed to apply some rules of the active IPsec policy on the computer",
        ...
        [5466] = "Domain IPsec policy unavailable; cached policy used",
        [5467] = "Domain IPsec policy reachable; no changes found",
        [5468] = "Domain IPsec policy changes applied",
        ...
        [6145] = "Errors processing Group Policy security settings",
        ...
        [6405] = "BranchCache repeated event summary",
        [6406] = "Product registered for Windows Firewall filtering",
        [6408] = "Filtering product failed; Windows Firewall resumed filtering",
        ...
        [6419] = "Device disable requested",
        [6420] = "A device was disabled",
        [6421] = "Device enable requested",
        [6422] = "A device was enabled",
        [6423] = "The installation of this device is forbidden by system policy",
        [6424] = "The installation of this device was allowed, after having previously been forbidden by policy",
        [6425] = "A network client used a legacy RPC method to modify authentication information on a trusted domain object",
    }.ToFrozenDictionary();

    public static IReadOnlyDictionary<int, string> All => Labels;

    public static string GetDescription(int? eventCode) => eventCode is not { } code
        ? "Event code unavailable"
        : Labels.GetValueOrDefault(code, "Unmapped Security event");
}
