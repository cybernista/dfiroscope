...
internal static class CliCommandDispositionCatalog
{
    private static readonly IReadOnlyList<CliAgentCommandDisposition> AgentCommandsValue =
        ...
        [
            ...
            Runnable(AgentCommandKind.GetHostMonitoringConfiguration, CliCommandKind.HostMonitoringConfigurationShow,
                CliSharedServiceBoundary.ViewerHostMonitoringActionService, FeatureIds.WindowsSecurityEvents,
                "Published Windows Security monitoring reads use the exact source-scoped typed configuration contract."),
            Runnable(AgentCommandKind.SaveHostMonitoringConfiguration, CliCommandKind.HostMonitoringConfigurationSave,
                CliSharedServiceBoundary.ViewerHostMonitoringActionService, FeatureIds.WindowsSecurityEvents,
                "Published Windows Security monitoring saves use the exact source-scoped typed configuration contract."),
            Runnable(AgentCommandKind.CheckHostMonitoringConfiguration, CliCommandKind.HostMonitoringConfigurationCheck,
                CliSharedServiceBoundary.ViewerHostMonitoringActionService, FeatureIds.WindowsSecurityEvents,
                "Published Windows Security monitoring checks use the exact source-scoped typed configuration contract."),
            Runnable(AgentCommandKind.DeployHostMonitoringConfiguration, CliCommandKind.HostMonitoringDeploy,
                CliSharedServiceBoundary.ViewerHostMonitoringActionService, FeatureIds.WindowsSecurityEvents,
                "Published Windows Security monitoring deployment is typed, source-scoped, confirmation-gated, and reversible."),
            Runnable(AgentCommandKind.ReverseHostMonitoringDeployment, CliCommandKind.HostMonitoringReverse,
                CliSharedServiceBoundary.ViewerHostMonitoringActionService, FeatureIds.WindowsSecurityEvents,
                "Published Windows Security monitoring reversal restores only the exact source-scoped recorded baseline."),
